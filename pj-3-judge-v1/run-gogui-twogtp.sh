...
P1B='./nogo --shell --name="Hollow-Black" --black="mcts simu=1500 parallel=4"'
P1W='./nogo --shell --name="Hollow-White" --white="mcts simu=1500 parallel=4"'
# commands for local player 2
P2B='./nogo-judge --shell --name="Judge-Black" --black="weak"'
P2W='./nogo-judge --shell --name="Judge-White" --white="weak"'
